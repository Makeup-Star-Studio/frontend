...
class NonBridalMakeupServicesProvider extends ChangeNotifier {
  ...
  Future<void> fetchNonBridalMakeupServices() async {
    try {
      _isLoading = true;
      notifyListeners();

      final response = await _apiService.get(ApiConstant.getNonBridalMakeupServices);
