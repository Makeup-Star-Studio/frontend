...
class DrapingServicesProvider extends ChangeNotifier {
  ...
  Future<void> fetchDrapingServices() async {
    try {
      _isLoading = true;
      notifyListeners();

      final response = await _apiService.get(ApiConstant.getDrapingServices);
