...
class NonBridalHairServicesProvider extends ChangeNotifier {
  ...
  Future<void> fetchNonBridalHairServices() async {
    try {
      _isLoading = true;
      notifyListeners();

      final response = await _apiService.get(ApiConstant.getNonBridalHairServices);
